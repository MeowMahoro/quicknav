 ...
 * <p>
 * This is a port of Skyblocker's reader of the same name; the NEU repository ships item NBT in the
 * legacy format (e.g. lists with explicit indices like {@code [0:"a",1:"b"]}), which the vanilla
 * {@link TagParser} cannot read.
 */
