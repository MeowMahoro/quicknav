...
import net.quicknav.repo.NEURepoManager;
...
public class QuickNavMod implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		// Loads the NEU item repository in the background (zip download + version cache) and imports the item list once it is ready.
		NEURepoManager.init();
		ItemRepository.init();
