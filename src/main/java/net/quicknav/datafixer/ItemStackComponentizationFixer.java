...
public class ItemStackComponentizationFixer {
	...
	public static ItemStack fixUpItem(CompoundTag nbt) {
		Dynamic<Tag> dynamic = DataFixers.getDataFixer().update(References.ITEM_STACK, new Dynamic<>(QuickNavUtils.getRegistryWrapperLookup().createSerializationContext(NbtOps.INSTANCE), nbt), ITEM_NBT_DATA_VERSION, ITEM_COMPONENTS_DATA_VERSION);
